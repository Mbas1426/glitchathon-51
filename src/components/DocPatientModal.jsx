...
import { PHYSICIANS, PATIENTS, CARE_PROTOCOLS, TEST_HISTORY, OUTREACH_RESPONSES, getRiskTier, getRiskColor, getStatusBadge, diagIcon, getChannelIcon } from  "../CareAgent_Combined.jsx";
